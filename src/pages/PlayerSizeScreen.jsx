function PlayerSizeScreen(props) {
	return (
		<div className="flex flex-col items-center gap-8">
			...
			<div>
				...
				<button
					onClick={props.onLocalMultiplayer}
					className="bg-blue-500 p-2 text-white rounded-xl w-40 h-16 hover:bg-blue-600 active:bg-blue-800"
				>
					Local Multiplayer
				</button>
			</div>
